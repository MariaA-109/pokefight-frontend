      ...
      <div className="wrapper">
        ...
        <div className="main_Flex">
          ...
          <div className="cardRight">
            ...
            <img  className="rightPokePic"  src={randomPokemon.sprites.other.dream_world.front_default} alt={randomPokemon.name} />
          </div>
        </div>
        <div> <button onClick={[]} className="fight_button"> Fight</button> </div>
      </div>
    </div>
  );
}
